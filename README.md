...
`█████████████░░░░  13 / 17 complete  ·  phase 5 in progress  ·  next: Computer Vision`
...
| Metric | Value |
|--------|-------|
| Courses completed | **13 / 17** |
| Hours logged across completed courses | **54** |
| Exercise files archived | **76** |
| Certificates earned | **13** |
| Current milestone | Deep learning - neural networks from a single dense neuron to a regularized binary classifier, built and trained in Keras |
| Last completed course | [Intro to Deep Learning](./13_IntroToDeepLearning/) - June 18, 2026 |
| Up next | [Computer Vision](https://www.kaggle.com/learn/computer-vision) |
...
Phase 5  ·  Specialized Topics     █████░░░░░░░░░   33%   2 / 6
```
...
| 14 | [Computer Vision](https://www.kaggle.com/learn/computer-vision) | 4h | Up next |
...
Aggregated from the thirteen completed courses. Each skill is exercised in at least one solved notebook.
...
└── 13_IntroToDeepLearning/         ✓ complete - latest
```
